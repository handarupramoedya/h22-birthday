...
// --- TOMBOL PEMICU IZIN AUDIO DI MOBILE ---
...
if (startAudioBtn) {
    startAudioBtn.addEventListener('click', () => {
        ...
        startAudioBtn.style.display = 'none'; // Sembunyikan tombol setelah izin didapatkan
    });
}
...
if (tuner) {
    tuner.addEventListener('input', (e) => {
        ...
        if(distance === 0) {
            ...
            if (!gainNode || !audioCtx) return; // Mencegah error jika tombol belum diklik
            let maxDistance = 30; //
